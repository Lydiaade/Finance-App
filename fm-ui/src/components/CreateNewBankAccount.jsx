...
class CurrentAccountOverview extends Component {
  ...
  constructor(props) {
    ...
    this.handleAccountCurrencyChange =
      this.handleAccountCurrencyChange.bind(this);
  ...
  handleSubmit(event) {
    ...
    let payload = {
      ...
      sortCode: this.state.account.sortCode.join("-"),
  ...
  setSortCode(place, event) {
    let sortCode = this.state.account.sortCode;
    sortCode[place] = event.target.value;
    this.setState((prevState) => ({
      account: {
        ...prevState.account,
        sortCode: sortCode,
      ...
      <div className="new-account-form container">
        ...
        <Form onSubmit={this.handleSubmit} onReset={this.handleReset}>
          ...
          <Form.Group
            as={Row}
            className="mb-3"
            controlId="formHorizontalAccountType"
          >
            <Form.Label column sm={4}>
              Account Type:
            </Form.Label>
          ...
          <Form.Group
            as={Row}
            className="mb-3"
            controlId="formHorizontalSortCode"
          >
            <Form.Label column sm={4}>
              Sort Code:
            </Form.Label>
            <Col>
              <input
                type="text"
                className="form-control"
                name="Sort Code Part 1"
                maxLength={2}
                value={this.state.account.sortCode[0]}
                onChange={(e) => this.setSortCode(0, e)}
              />
            </Col>
            <Col>
              <input
                type="text"
                className="form-control"
                name="Sort Code Part 2"
                maxLength={2}
                value={this.state.account.sortCode[1]}
                onChange={(e) => this.setSortCode(1, e)}
              />
            </Col>
            <Col>
              <input
                type="text"
                className="form-control"
                name="Sort Code Part 3"
                maxLength={2}
                value={this.state.account.sortCode[2]}
                onChange={(e) => this.setSortCode(2, e)}
              />
            </Col>
          </Form.Group>
          <Form.Group
          ...
          <Form.Group
            as={Row}
            className="mb-3"
            controlId="formHorizontalBankName"
          >
            <Form.Label column sm={4}>
              Bank Name:
            </Form.Label>
            <Col sm={8}>
              <select
                value={this.state.account.accountBank}
                onChange={this.handleAccountBankChange}
                className="form-control"
              >
          ...
          <Form.Group
            as={Row}
            className="mb-3"
            controlId="formHorizontalCurrency"
          >
            <Form.Label column sm={4}>
              Currency:
            </Form.Label>
            <Col sm={8}>
              <select
                ...
                onChange={this.handleAccountCurrencyChange}
                className="form-control"
              >
